...
{
  /* ECT_PBCTL: PBEN=1 */
  setReg8Bits(ECT_PBCTL, 0x40U);       /* Enable 16-bit pulse accumulator */ 
  return ERR_OK;                       /* OK */
}
...
{
  /* ECT_PBCTL: PBEN=0 */
  clrReg8Bits(ECT_PBCTL, 0x40U);       /* Disable 16-bit pulse accumulator */ 
  return ERR_OK;                       /* OK */
}
...
*/
/*
void Encoder_B_ResetCounter(void)

**      This method is implemented as macro. See Encoder_B.h file.      **
*/
...
*/
/*
Encoder_B_TCounterValue Encoder_B_GetCounterValue(void)
...
{
  /* ECT_TIE: C0I=0 */
  clrReg8Bits(ECT_TIE, 0x01U);         /* Disable interrupt by edge detector */ 
  /* ECT_PBCTL: PBEN=1 */
  setReg8Bits(ECT_PBCTL, 0x40U);       /* Enable pulse accumulator */ 
}
